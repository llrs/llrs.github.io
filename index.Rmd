...
It started as a way to randomize some samples to be sequenced in the lab.
It randomize the samples considering whatever variables that could affect the 
batch effect and that have been stored before sequencing. 
